const fetchFanFave =async()=>{
    try {
        let data = await fetch("http://localhost:3000/fan-fav")
        console.log(data);
        ...
        document.querySelector(".fan-fav-wraper").insertAdjacentHTML("beforeend",FanCover)
